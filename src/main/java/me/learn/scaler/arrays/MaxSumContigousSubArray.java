...
//        int sol = new MaxSumContigousSubArray().solve( new int[]{1, 2, 3, 4, -10});
    ...
    /**
     * Solution using carrry sum approach.
     * TC: O(n)
     * SC: O(1)
     */
